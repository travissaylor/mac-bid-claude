...
7. **Max bid**:
   `python3 scripts/max_bid.py --median <m> --tax <rate> --location {home|transfer|remote} [--location-cost <num>] [--lot-fee <override>] [--buyers-premium <override>] --current-bid <current>`
...
```json
{
  ...
  "max_bid": 237.95,
  "deal_score": 11.7,
  "recommendation": "max bid $237.95 | manual review | advisory (low comp count)",
  "condition": "LIKE NEW",
